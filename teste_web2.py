...
def abrir_pagina_web():
    url = "pagina.html" 
    webbrowser.open_new_tab(f"file://{os.path.abspath('pagina.html')}")
...
choose_language['values'] = (
    ...
    'kazakh', 'khmer', 'korean', 'kurdish (kurmanji)', 'kyrgyz', 'lao', 'latin', 'latvian',
    'lithuanian', 'luxembourgish', 'macedonian', 'malagasy', 'malay', 'malayalam', 'maltese',
    'maori', 'marathi', 'mongolian', 'myanmar (burmese)', 'nepali', 'norwegian', 'odia', 'pashto',
...
btn1 = Button(framel, command=translate, text="Translate", relief=FLAT, borderwidth=2, font=('verdana', 10, 'bold'),
              bg='#248aa2', cursor="hand2", fg='white')
btn1.place(x=185, y=300)

btn2 = Button(framel, command=clear, text=" Clear  ", relief=FLAT, borderwidth=2, font=('verdana', 10, 'bold'),
              bg='#248aa2', anchor="center", fg='white')
btn2.place(x=300, y=300)

# Botão para abrir página web
btn4 = Button(framel, command=abrir_pagina_web, text="Abrir Página Web", relief=FLAT, borderwidth=2,
              font=('verdana', 10, 'bold'), bg='#248aa2', cursor="hand2", fg='white')
btn4.place(x=420, y=300)
...
btn3 = Button(root, image=tk_image, relief=FLAT, borderwidth=0, highlightthickness=0, cursor="hand2", padx=0, pady=0,
              bd=0, command=audio)
btn3.image = tk_image
btn3.pack()
