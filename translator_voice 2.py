...
btn3 = Button(root, image=tk_image, relief=FLAT, borderwidth=0, highlightthickness=0, cursor="hand2", padx=0, pady=0, bd=0, bg='systemTransparent', activebackground='systemTransparent', command=audio)
btn3.image = tk_image  
btn3.pack()
...
'''btn3 = Button(
    framel,
    command=audio,
    image=imagem,                  # Emoji de áudio
    relief=FLAT,                # Remove o relevo 3D
    borderwidth=2,              # Sem borda
