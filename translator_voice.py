...
framel = Frame(root, width=590, height=370, relief=RIDGE, borderwidth=5, bg='#FF8C00')
framel.place(x=0, y=0)

Label(root, text="Language Translator", font=("Helvetica 20 bold"), fg="white", bg='#FF8C00').pack(pady=10)
...
text_entry1 = Text(framel, width=20, height=7, borderwidth=5, relief=FLAT, font=('verdana', 15))
text_entry1.place(x=10, y=100)

text_entry2 = Text(framel, width=20, height=7, borderwidth=5, relief=FLAT, font=('verdana', 15))
...
btn3 = Button(
    ...
    command=audio,
    text="🔊",                  # Emoji de áudio
    font=("Arial", 14),         # Tamanho grande para o emoji
    relief=FLAT,                # Remove o relevo 3D
    borderwidth=0,              # Sem borda
    bg='#248aa2',                 # Fundo igual ao do Frame
    activebackground='#248aa2',   # Mantém invisível ao clicar
    highlightthickness=0,       # Remove a borda de foco
    cursor="hand2"              # Mostra a mãozinha ao passar o mouse
)
btn3.place(x=390, y=300)
